    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <?= form_dropdown('delivered_by', $opts, (isset($_POST['delivered_by']) ? $_POST['delivered_by'] : $delivery->delivered_by), 'class= "form-control" id="delivered_by" required="required" style="width:100%;" '); ?>
