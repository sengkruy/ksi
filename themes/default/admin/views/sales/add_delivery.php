            ...
            isset($_POST['address']) ? $_POST['address']
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <?= form_dropdown('delivered_by', $opts, "", 'class= "form-control" id="delivered_by" required="required" style="width:100%;" '); ?>
                        <!-- <?= form_input('delivered_by', (isset($_POST['delivered_by']) ? $_POST['delivered_by'] : ''), 'class= form-control" id="delivered_by" required="required" style="width:100%";'); ?> -->
                    </div>
