...
<head>
    ...
    <link href="<?= $assets ?>styles/style.css?version=523" rel="stylesheet"/>
        ...
        <div class="container">
            ...
            <style>
                    .custom-btn {
                        ...
                        border-radius: 5px; /* Optional: Make it rounded */
            ...
            <div class="btn-group visible-xs pull-right btn-visible-sm">
                <button class="navbar-toggle btn custom-btn" type="button" data-toggle="collapse" data-target="#sidebar_menu">
                ...
                <?php if (POS) {
                    ?>
                <a href="<?= admin_url('purchases/add') ?>" class="btn custom-btn">
                    <span class="fa fa-plus-square"></span>
                </a>
                <a href="<?= admin_url('transfers/add') ?>" class="btn custom-btn">
                    <span class="fa fa-exchange"></span>
                </a>
                <a href="<?= admin_url('products_both/1') ?>" class="btn custom-btn">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    <li id="products_index">
                                        <a class="submenu" href="<?= admin_url('products/1'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= lang('list_products'); ?></span>
                                        </a>
                                    </li>
                                    <li id="products_index_both">
                                        <a class="submenu" href="<?= admin_url('products_both/1'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= "LP"; ?></span>
                                        </a>
                                    </li>
                                    <li id="products_transfer_12">
                                        <a class="submenu" href="<?= admin_url('products_transfer_12'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= "1-2 Transfer Suggestion"; ?></span>
                                        </a>
                                    </li>
                                    <li id="products_transfer_21">
                                        <a class="submenu" href="<?= admin_url('products_transfer_21'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= "2-1 Transfer Suggestion"; ?></span>
                                        </a>
                                    </li>
                                    <li id="products_add">
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="sales_index">
                                        <a class="submenu" href="<?= admin_url('salesquick'); ?>">
                                            <i class="fa fa-heart"></i>
                                            <span class="text"> List Sales Summary</span>
                                        </a>
                                    </li> 
                                    <?php if (POS) {
                                        ?>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_detail_sales">
                                        <a href="<?= admin_url('reports/daily_sales_detail') ?>">
                                            <i class="fa fa-bars"></i><span class="text"> Daily Sales Quantity</span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_index_both">
                                        <a class="submenu" href="<?= admin_url('products_both/1'); ?>">
                                            <i class="fa fa-barcode"></i><span class="text"> LP</span>
                                        </a>
                                    </li>
                                    <li id="products_transfer_12">
                                        <a class="submenu" href="<?= admin_url('products_transfer_12'); ?>">
                                            <i class="fa fa-barcode"></i><span class="text">1-2 Transfer Suggestion </span>
                                        </a>
                                    </li>
                                    <li id="products_transfer_21">
                                        <a class="submenu" href="<?= admin_url('products_transfer_21'); ?>">
                                            <i class="fa fa-barcode"></i><span class="text">2-1 Transfer Suggestion </span>
                                        </a>
                                    </li>
