...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('products/getProducts_both' . ($warehouse_id ? '/' . $warehouse_id : '') . ($supplier ? '?supplier=' . $supplier->id : '')) ?>',
            ...
            "aoColumns": [
                ...
                {"bSortable": false,"mRender": img_hl},
                 ...
                 null, 
               //  null, 
               {"mRender": formatQuantity}, // QTY Pawfect 
               {"mRender": formatQuantity}, //QTY petland
            ...
            {column_number: 4, filter_default_label: "[QTY Petland]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[QTY Pawfect]", filter_type: "text", data: []},
            {column_number: 6, filter_default_label: "[Total QTY]", filter_type: "text", data: []},
