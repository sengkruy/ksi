                        ...
                        <div class="panel panel-default margin-top-lg">
                            ...
                            <div class="panel-body mprint">
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <?php if (!$shop_settings->hide_price) {
                                            ?>
                                            <?php if (('standard' != $product->type || $warehouse->quantity > 0) || $Settings->overselling) {
                                                ?>
                                        ...
                                        <div class="form-group">
                                                ...
                                                if ($variants) {
                                                    foreach ($variants as $variant) {
                                                        $opts[$variant->id] = $variant->name . ($variant->price > 0 ? ' (+' . $this->sma->convertMoney($variant->price, true, false) . ')' : (0 == $variant->price ? '' : ' (+' . $this->sma->convertMoney($variant->price, true, false) . ')'));
                                                    }
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped dfTable table-right-left">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?= lang('price'); ?></td>
                                                        <td><?= $this->sma->convertMoney($product->special_price ?? $product->price); ?></td>
                                                    </tr>
                                                        <?php
                                                    } ?>
                                                    ...
                                                    if ($product->promotion) {
                                                        echo '<tr><td>' . lang('promotion') . '</td><td><strong>' . $this->sma->convertMoney($product->promo_price) . '</strong><br>' . ($product->start_date && '0000-00-00' != $product->start_date ? lang('start_date') . ': <strong>' . $this->sma->hrsd($product->start_date) . '</strong><br>' : '') . ($product->end_date && '0000-00-00' != $product->end_date ? lang('end_date') . ': <strong>' . $this->sma->hrsd($product->end_date) . '</strong>' : '') . '</td></tr>';
                                                    }
                                                    ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= 0 == $product->tax_method ? lang('inclusive') : lang('exclusive'); ?></td>
                                                    </tr>
                                                        <?php
                                                    } ?>
                                                    ...
                                                    <?php if (!empty($warehouse) && 'standard' == $product->type) {
                                                        ?>
                                                    <tr>
                                                        <td><?= lang('in_stock'); ?></td>
                                                        ...
                                                        foreach ($options as $option) {
                                                            if (0 != $option->wh_qty) {
                                                                ...
                                                                if (!$shop_settings->hide_price) {
                                                                    ...
                                                                    echo '<td>' . lang('price') . ': ' . $this->sma->convertMoney(($product->special_price ?? $product->price) + $option->price) . '</td>';
                                                                    echo '</tr>';
                                                                } else {
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <?= $product->product_details ? '<div class="panel panel-default"><div class="panel-heading">' . lang('product_details') . '</div><div class="panel-body">' . stripslashes($product->product_details) . '</div></div>' : ''; ?>
