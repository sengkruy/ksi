...
$route['admin/salesv2']     = 'admin/sales/indexsalesfilterv2';
$route['admin/sales']     = 'admin/sales/index';

$route['admin/sales/(:num)']     = 'admin/sales/index/$1';
$route['admin/salesquick']     = 'admin/sales/indexsalesquick';
$route['admin/salesquick/(:num)']     = 'admin/sales/indexsalesquick/$1';
$route['admin/save_search_term'] = 'admin/sales/save_search_term';
$route['admin/products/(:num)']  = 'admin/products/index/$1';
$route['admin/products_both']  = 'admin/products/index_both';
$route['admin/exportStockCount']  = 'admin/products/exportStockCount';
$route['admin/products_transfer_12']  = 'admin/products/transfer_suggestion_12';
$route['admin/products_transfer_21']  = 'admin/products/transfer_suggestion_21';
$route['admin/products_both/(:num)']  = 'admin/products/index_both/$1';
