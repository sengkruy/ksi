...
|
*/
//$config['base_url'] = 'http://165.22.48.239/smaold/';
$config['base_url'] = 'https://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/ksi_test/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
$config['encryption_key'] = '4WfhT5ji7N0tgE9dYVC8ZbJkXDHFPlQr2ymOs';
